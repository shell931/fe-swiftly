...
@Component({
    selector: 'app-RefreshPageAfterWelcome',
    templateUrl: './RefreshPageAfterWelcome.component.html',
    styleUrls: ['./RefreshPageAfterWelcome.component.scss']
})

export class RefreshPageAfterWelcomeComponent implements OnInit {
